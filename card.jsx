...
export function Card({ className = '', children }) {
  return <div className={`border rounded-xl p-4 ${className}`}>{children}</div>
}
export function CardHeader({ children }) { return <div className="mb-3">{children}</div> }
export function CardTitle({ children }) { return <h3 className="text-xl font-semibold">{children}</h3> }
